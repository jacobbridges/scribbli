...
from siteapi.views import Signup, AlphaInvitation, Writer, Login, World, UniverseDetail, \
    DestinationList, UniverseList, UniverseCreate, UniverseUpdate, UniverseDelete
...
urlpatterns = [
    ...
    url(r'^universe/(?P<pk>\d+)/update/$', UniverseUpdate.as_view()),
    url(r'^universe/(?P<pk>\d+)/delete/$', UniverseDelete.as_view()),
